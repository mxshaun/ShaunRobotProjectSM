...
public final class Wielaandrijving {
	 ...
	 * 
	 * Let op! Bij een maximale lineaire snelheid kan de robot niet een kant op draaien, omdat het draaien een hogere snelheid
	 * van het ene wiel te overstaande van het andere wiel vereist.
	 * 
	 * @param lineaireSnelheid, de eenheden afstand per seconde, die de robot rechtvooruit aflegt.
	 ...
	 * 
	 * Let op! Deze methode zorgt er eerst voor dat de robot stil staat! Dus als de robot draaiende om de as is, 
